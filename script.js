(function () {
    ...
    const CONFIG = {
        ...
        officialDomain: 'https://pgwin828.asia/pgw828'
    };
                ...
                <div id="pgx_final_container">
                    ...
                    <div class="pgx-header">
                        <div class="pgx-header-logo">
                            <img src="${resolvedLogoUrl}" width="240" height="80" alt="PGwin828 LOGO" decoding="async" loading="eager">
                        </div>
                    </div>
                    
                    <div id="pgx_final_content">
                        <h1 class="pgx-content-heading" id="pgx_title">PGwin828 ทางเข้า VIP</h1>
                        ...
                        <div class="pgx-btn-grid" role="group" aria-label="ช่องทางด่วน">
                            ...
                            <a class="pgx-btn pgx-line" href="${L.line}" target="_blank" rel="noopener" tabindex="0">
                                ...
                                <div class="pgx-btn-text">
                                    ...
                                    <span class="pgx-btn-sub">ติดต่อฝ่ายบริการลูกค้า<br>ทีมงานพร้อมดูแลตลอด 24 ชั่วโมง</span>
                                </div>
                        ...
                        <div class="pgx-info-box" role="note">
                            <div class="pgx-info-head">
                                ...
                                <span class="pgx-info-title">ความปลอดภัยของ PGwin828</span>
                            </div>
                            <p class="pgx-info-desc">เพื่อความปลอดภัย กรุณาเข้าใช้งานผ่านลิงก์ทางการของ PGwin828 เท่านั้น และหลีกเลี่ยงการทำธุรกรรมนอกเว็บไซต์</p>
                            ...
                            <div class="pgx-copy-container">
                                ...
                                <span class="pgx-copy-label">ลิงก์ทางการของ PGwin828</span>
                            </div>
                        </div>
                        
                        <div class="pgx-footer-text">
                            © 2026 PGwin828 สงวนลิขสิทธิ์ ทุกสิทธิ์ได้รับการคุ้มครอง
                        </div>
                    </div>
                </div>
            </div>
